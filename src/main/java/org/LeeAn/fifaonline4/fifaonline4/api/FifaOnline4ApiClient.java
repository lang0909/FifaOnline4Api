...
public class FifaOnline4ApiClient {
    ...
    private final String api_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50X2lkIjoiODIyMjE4NjgzIiwiYXV0aF9pZCI6IjQiLCJ0b2" +
        "tlbl90eXBlIjoiQWNjZXNzVG9rZW4iLCJzZXJ2aWNlX2lkIjoiNDMwMDExNDgxIiwiWC1BcHAtUmF0ZS1MaW1pdCI6IjIwMDAwOjEwIiwibmJmIjoxNTk0OTA3N" +
        "zQwLCJleHAiOjE2NTc5Nzk3NDAsImlhdCI6MTU5NDkwNzc0MH0.fLAciexZOYdlTlu2v8tHwYoY7ZuhWq5xTqgeXXNzdcs";
    ...
    public TopRankerUsingAverage[] requestTopRankerUsingAverage(int matchtype, JSONArray players){
        final HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization",api_key);
        final HttpEntity<String> entity = new HttpEntity<>(headers);
